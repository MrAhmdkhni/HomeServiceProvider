...
public class ExpertRegistrationService {
    ...
    public ExpertRegistrationService(ConfirmationTokenService confirmTokenService, EmailService emailService, ExpertService expertService) {
    ...
    public String register(Expert expert, String imageName, Long imageSize) {
        ...
        emailService.sendEmail(expert.getEmail(), createEmail(expert.getFirstname(), link));
    ...
    public String confirmToken(String token) {
        ...
        expertService.activeExpert(confirmToken.get().getPerson().getEmail(), ExpertStatus.AWAITING);
